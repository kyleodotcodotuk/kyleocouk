    ...
    <footer>
      <div className="wrapper">
        ...
        <p>London, UK &nbsp;<i className="fa fa-map-pin"></i><br />
          ...
          {new Date().getFullYear()} &nbsp;<i className="fa fa-calendar"></i><br />Coded with <a target="_blank" href="https://github.com/kyleodotcodotuk/kyleocouk" title="Repository" rel="noreferrer">React</a> <i className="fa fa-code"></i>&nbsp; </p>
