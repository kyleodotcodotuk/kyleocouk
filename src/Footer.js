  ...
  return (
    <footer>
      <div className="wrapper">
        ...
        Kyle O'Connor &nbsp;<i className="fa fa-bicycle"></i>&nbsp; https://kyleo.co.uk &nbsp;<i className="fa fa-mouse-pointer"></i>&nbsp; <a href="/docs/privacy_policy.pdf" target="_blank" alt="Privacy Policy" title="Privacy Policy">Privacy Policy</a>  &nbsp;<i className="fa fa-legal"></i>&nbsp;<br />
