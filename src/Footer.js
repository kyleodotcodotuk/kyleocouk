    ...
    <footer>
      <div className="wrapper">
        ...
        <p>Kyle O'Connor &nbsp;<i className="fa fa-bicycle"></i><br />
          ...
          &copy; <a href="/docs/privacy_policy.pdf" target="_blank" alt="Privacy Policy" title="Privacy Policy">Privacy Policy</a>  &nbsp;<i className="fa fa-legal"></i>&nbsp;{new Date().getFullYear()} &nbsp;<i className="fa fa-calendar"></i><br />
